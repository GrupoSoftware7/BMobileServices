...
public class EnviarCorreo {
    ...
    public EnviarCorreo(ServletContext context) {
    ...
    public MimeMessage newMail (String subject, String to, String content, Session sesion){
        ...
        try {
            ...
            Logger.getLogger(EnviarCorreo.class.getName()).log(Level.WARNING, "Dirección de destino no válida", ex);
            return null;
        } catch (MessagingException ex){
            Logger.getLogger(EnviarCorreo.class.getName()).log(Level.WARNING, "Error creando el mensaje", ex);
            return null;
        }    
    }
    ...
    public boolean sendEmail (Message mensaje, Session sesion){
        ...
        try {
            ...
            Logger.getLogger(EnviarCorreo.class.getName()).log(Level.SEVERE, "Error conectando con SMTP", ex);
            return false;
        }
        finally{
            if(transporte != null)  {
